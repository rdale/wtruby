...
class Composer < Wt::WCompositeWidget
  ...
  def createUi
    ...
    @edits.resize(Wt::WLength.new(100, Wt::WLength::Percentage), Wt::WLength.new)
    @edits.elementAt(0, 0).resize(Wt::WLength.new(1, Wt::WLength::Percentage), Wt::WLength.new)
    ...
    @subject.resize(Wt::WLength.new(99, Wt::WLength::Percentage), Wt::WLength.new)
