...
class HangmanGame < Wt::WTable
  ...
  def initialize(parent)
    super(parent)
    resize(Wt::WLength.new(100, Wt::WLength::Percentage), Wt::WLength.new)
    ...
    @backToGameText.decorationStyle.cursor = Wt::WCssDecorationStyle::Pointer
    @backToGameText.clicked.connect(SLOT(self, :showGame))
  
    @scoresText = Wt::WText.new(" Highscores ", elementAt(2, 0))
    @scoresText.decorationStyle.cursor = Wt::WCssDecorationStyle::Pointer
