...
class ChartConfig < Wt::WContainerWidget
  ...
  def addHeader(t, value)
    t.elementAt(0, t.columnCount).addWidget(Wt::WText.new(value))
  end
  ...
  def initialize(chart, parent)
    ...
    chartConfig.setMargin(Wt::WLength::Auto, Wt::Left | Wt::Right)
    ...
    for i in 0...chartConfig.rowCount
    ...
    p.resize(Wt::WLength.new(750), Wt::WLength::Auto)
    ...
    seriesConfig.setMargin(Wt::WLength::Auto, Wt::Left | Wt::Right)
