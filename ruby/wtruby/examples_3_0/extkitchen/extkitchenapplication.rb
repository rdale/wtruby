...
class ExtKitchenApplication < Wt::WApplication
  ...
  def initialize(env)
    ...
    north.resize(Wt::WLength::Auto, Wt::WLength.new(35))
    ...
    west.title = "Widgets"
    west.resize(Wt::WLength.new(200), Wt::WLength::Auto)
    west.resizable = true
  ...
  def createExampleNode(label, parentNode, f)
    ...
    node.label.textFormat = Wt::PlainText
...
#      @currentExample.dispose
  ...
  def menuAndToolBarExample
    ...
    wt = Wt::WText.new(tr("ex-menu-and-toolbar"), ex)
    wt.margin = Wt::WLength.new(5, Wt::Bottom)
  ...
  def formWidgetsExample
    ...
    wt = Wt::WText.new(tr("ex-form-widgets"), ex)
    wt.setMargin(Wt::WLength.new(5), Wt::Bottom)
...
=end
    ...
    button.setMargin(Wt::WLength.new(5), Wt::Left)
...
=end
    ...
    df.setMargin(Wt::WLength.new(5), Wt::Top | Wt::Bottom)
    ...
    @html.setMargin(Wt::WLength.new(5), Wt::Top | Wt::Bottom)
    ...
    split.children.last.resize(Wt::WLength.new(150), Wt::WLength::Auto)
    split.children.last.setMinimumSize(Wt::WLength.new(130), Wt::WLength::Auto)
    split.children.last.setMaximumSize(Wt::WLength.new(170), Wt::WLength::Auto)

    split.addWidget(Wt::WText.new("Center"))
    split.children.last.resize(Wt::WLength.new(100), Wt::WLength::Auto)
    split.children.last.setMinimumSize(Wt::WLength.new(50), Wt::WLength::Auto)
  
    split.addWidget(Wt::WText.new("Right"))
    split.children.last.resize(Wt::WLength.new(50), Wt::WLength::Auto)
    split.children.last.setMinimumSize(Wt::WLength.new(50), Wt::WLength::Auto)
    ...
    split.children.last.resize(Wt::WLength::Auto, Wt::WLength.new(100))
    split.children.last.setMinimumSize(Wt::WLength::Auto, Wt::WLength.new(50))
    split.children.last.setMaximumSize(Wt::WLength::Auto, Wt::WLength.new(196))
  ...
  def tableViewExample
    ...
    wt = Wt::WText.new(tr("ex-table-view"), ex)
    wt.setMargin(Wt::WLength.new(5), Wt::Bottom)
    ...
    # widget.
    #
    wt = Wt::WText.new(tr("ex-table-view2"), ex)
    wt.setMargin(Wt::WLength.new(5), Wt::Bottom)
  ...
  def dialogExample
    ...
    vLayout.addWidget(Wt::WText.new(tr("ex-dialogs")))
  ...
  def createDialog3
    ...
    nestedNorth.resize(Wt::WLength::Auto, Wt::WLength.new(35))
  ...
  def createDialog7
    ...
    passwd.textSize = 8
    passwd.margin = Wt::WLength.new(5, Wt::Left)
    passwd.inline = true
  ...
  def tabWidgetExample
    ...
    wt = Wt::WText.new(tr("ex-tabwidget"), ex)
    wt.margin = Wt::WLength.new(5, Wt::Bottom)
