...
class MandelbrotExample < Wt::WContainerWidget
  ...
  def initialize(parent = nil)
    super(parent)
    Wt::WText.new('<div style="height:1px; width: 1px;"/>' \
...
=end
    ...
    buttons.resize(Wt::WLength.new(400), Wt::WLength::Auto)
...
Wt::WRun(ARGV) do |env|
  ...
  mandelbrot = MandelbrotExample.new
  mandelbrot.padding = Wt::WLength.new(8)
