...
# push ( @wtheaders, "@CMAKE_CURRENT_SOURCE_DIR@/DomElement.h" );

# Launch kalyptus
chdir "../smoke/wt";
system "perl -I@kdebindings_SOURCE_DIR@/kalyptus @kdebindings_SOURCE_DIR@/kalyptus/kalyptus @ARGV --qt4 --globspace -fsmoke --name=wt $macros --no-cache --outputdir=$outdir @wtheaders";
my $exit = $? >> 8;
exit $exit if ($exit);
chdir "$kalyptusdir";
